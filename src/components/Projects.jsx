...
const projects = [
  {
    ...
    tech: ['ASP.NET Core', '.NET 7', 'React.js', 'Hangfire', 'AWS S3', 'Google Drive API', 'OAuth2', 'Razorpay', 'SQL Server'],
    desc: 'Multi-tenant SaaS platform for professional photographers. Engineered a pluggable cloud storage layer (Wasabi S3 + Google Drive OAuth2) with a hybrid provider pattern, Hangfire background automation, and Razorpay subscription flows.',
    highlights: [
      'Designed IStorageProvider abstraction routing between Wasabi S3 and Google Drive API (OAuth2) per tenant with pre-signed upload URLs',
      'Built Hangfire background service automating soft-delete cleanup across cloud storage and SQL database within transactions',
    ],
    client: 'Picxly',
