...
const projects = [
  {
    ...
    tech: ['ASP.NET Core', '.NET 7', 'React.js', 'Hangfire', 'Razorpay', 'SQL Server', 'Webhooks', 'FDMS'],
    desc: 'Multi-tenant SaaS platform for professional photographers — AI-powered culling, face recognition, and gallery delivery. Contributed to admin-facing processing dashboard and payment subscription flows.',
    highlights: [
      'Built processing dashboard showing FDMS service load, subscription management, and Razorpay webhook event logs',
      'Implemented Razorpay recurring subscription flows with webhook handlers for payment lifecycle events',
    ],
    client: 'Picxly',
